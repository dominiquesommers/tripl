...
// import {PlaceBooking, IPlaceBooking, NewPlaceBooking, UpdatePlaceBooking} from '../models/place-booking';
// import {RouteBooking, IRouteBooking, NewRouteBooking, UpdateRouteBooking} from '../models/route-booking';
//
...
//         return new Trip(
//           data.trip, countries, countryNotes, seasons, places, activities, placeNotes, routes, routeNotes,
//           expenses, placeBookings, routeBookings, this
//         );
//       }),
...
//       updates,
//       (updatedData) => {
//         return; // handle plan updates properly, based on planId.
//         // plan.update(updates)
//       },
//       {
...
//       return of(null);
//     }
//     const newPlaceNoteData: NewPlaceNote = { place_id: placeId, trip_id: currentTrip.id, description: description, category: 'undefined', included: true, estimated_cost: 0 };
//     return this.persist(
...
//       return of(null);
//     }
//     const newCountryNoteData: NewCountryNote = { country_id: countryId, trip_id: currentTrip.id, description: description, category: 'undefined', included: true, estimated_cost: 0 };
//     return this.persist(
...
//       return of(null);
//     }
//     const newRouteNoteData: NewRouteNote = { route_id: routeId, trip_id: currentTrip.id, description: description };
//     return this.persist(
