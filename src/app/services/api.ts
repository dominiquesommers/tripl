...
export class ApiService {
  ...
  //   return this.http.get<ITrip[]>(`${environment.apiUrl}/trips.json`).pipe(delay(this.d));
  // }
  //
  // // 2. Trip Metadata
  // getTrip(id: string) {
  ...
  //   return this.http.get<IPlace[]>(`${environment.apiUrl}/places.json`).pipe(delay(this.d));
  //
  //   // const mock = [
  //   //   { id: 'loc1', trip_id: tripId, name: 'Paris', country_id: 'fr', season_id: 's1', lat: 48.85, lng: 2.35 },
  //   //   { id: 'loc2', trip_id: tripId, name: 'Cochrane / Parque Nacional Patagonia', country_id: 'de', season_id: 's2', lat: 52.52, lng: 13.40 },
  ...
  //   return this.http.get<IRoute[]>(`${environment.apiUrl}/routes.json`).pipe(delay(this.d));
  //   // const mock: IRoute[] = [
  ...
  //   return this.http.get<IVisit[]>(`${environment.apiUrl}/visits2.json`).pipe(delay(this.d));
  //   const mock = [
  ...
  // // 6. Reference Data
  // getCountries() {
  //   return this.http.get<ICountry[]>(`${environment.apiUrl}/countries.json`).pipe(delay(this.d));
  //   // const mock = [
  ...
  //
  // getSeasons() {
  //   return this.http.get<ISeason[]>(`${environment.apiUrl}/seasons.json`).pipe(delay(this.d));
  //   // const mock = [
  ...
  // // getCountries() { return of({}).pipe(delay(2000)); } //this.http.get<ICountry[]>(`${this.baseUrl}/countries.json`); }
